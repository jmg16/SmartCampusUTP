...
La base de datos está en **otro host**: **192.168.10.11**, puerto **5432**. Base: `bitacora_db`, usuario: `bitacora_admin`. Desde el servidor donde corre la API:
...
PGPASSWORD='TU_PASSWORD' psql -h 192.168.10.11 -p 5432 -U bitacora_admin -d bitacora_db -f scripts/init-bitacora.sql
```
...
BITACORA_DATABASE_URL=postgres://bitacora_admin:TU_PASSWORD@192.168.10.11:5432/bitacora_db
...
export BITACORA_DATABASE_URL="postgres://bitacora_admin:TU_PASSWORD@192.168.10.11:5432/bitacora_db"
...
2. Ejecutar `scripts/init-bitacora.sql` en la BD `bitacora_db` en 192.168.10.11:5432.
